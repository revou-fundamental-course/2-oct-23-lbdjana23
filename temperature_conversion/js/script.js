...
buttonConvert.addEventListener("click", function () {
  ...
  if (!isNaN(celsius)) {
    ...
    title.innerHTML = `Result  <br/> ${celsius} Celsius is equal to ${fahrenheit.toFixed(2)} Fahrenheit.`;
...
buttonReverse.addEventListener("click", function () {
  ...
  if (!isNaN(fahrenheit)) {
    ...
    title.innerHTML = `Result  <br/> ${fahrenheit} Fahrenheit is equal to ${celsius.toFixed(2)} Celsius.`;
